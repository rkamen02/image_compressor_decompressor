 ...
 * HW 4
 *
 * Program to compare two images, prints a ratio as a percent to stdout.
 */
 ...
 * to four decimal places. Difference is multiplied by 100.
 *
 * Prints 100.0000 if the image widths or heights differ by more than 1 each.
 *
